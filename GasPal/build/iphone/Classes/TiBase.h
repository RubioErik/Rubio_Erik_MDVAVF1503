...
// in simulator we redefine to format for CrimeFind Developer console
...
{\
	NSString * exceptionName = [@"org.crimefind." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.crimefind";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UICrimeFindNativeItemNone = -1, 
	UICrimeFindNativeItemSpinner = -2,
	UICrimeFindNativeItemProgressBar = -3,
	
	UICrimeFindNativeItemSlider = -4,
	UICrimeFindNativeItemSwitch = -5,
	UICrimeFindNativeItemMultiButton = -6,
	UICrimeFindNativeItemSegmented = -7,
	
	UICrimeFindNativeItemTextView = -8,
	UICrimeFindNativeItemTextField = -9,
	UICrimeFindNativeItemSearchBar = -10,
	
	UICrimeFindNativeItemPicker = -11,
	UICrimeFindNativeItemDatePicker = -12,
	
	UICrimeFindNativeItemInfoLight = -13,
	UICrimeFindNativeItemInfoDark = -14,
	
	UICrimeFindNativeItemDisclosure = -15,
	
	UICrimeFindNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all CrimeFind instances of
