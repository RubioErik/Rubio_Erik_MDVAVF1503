...
//@interface CrimeFindObject : NSObject
//@end

@interface CrimeFindObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[CrimeFindObject class]])
		{
			for (NSString *key in [[(CrimeFindObject*)o modules] allKeys])
			{
