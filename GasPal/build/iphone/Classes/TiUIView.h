...
/**
 Base class for all CrimeFind views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the CrimeFind view hierarchy (such as wrapped iOS UIViews) was touched.
