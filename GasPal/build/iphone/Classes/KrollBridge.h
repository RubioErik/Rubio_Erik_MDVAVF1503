...
@interface CrimeFindObject : KrollCoverageObject {
#else
@interface CrimeFindObject : KrollObject {
#endif
@private
...
extern NSString * CrimeFind$ModuleRequireFormat;
