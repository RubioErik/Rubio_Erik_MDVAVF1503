...
//@interface AVF_Project2Object : NSObject
//@end

@interface AVF_Project2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AVF_Project2Object class]])
		{
			for (NSString *key in [[(AVF_Project2Object*)o modules] allKeys])
			{
