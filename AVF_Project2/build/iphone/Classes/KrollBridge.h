...
@interface AVF_Project2Object : KrollCoverageObject {
#else
@interface AVF_Project2Object : KrollObject {
#endif
@private
...
extern NSString * AVF_Project2$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	AVF_Project2Object *_avf_project2;
    KrollObject* console;
	BOOL shutdown;
