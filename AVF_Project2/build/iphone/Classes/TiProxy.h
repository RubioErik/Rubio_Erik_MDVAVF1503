...
//Rare exceptions to indicate a bug in the _avf_project2 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for AVF_Project2 proxies.
 */
