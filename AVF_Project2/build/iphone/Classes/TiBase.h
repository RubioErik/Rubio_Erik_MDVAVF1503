...
// in simulator we redefine to format for AVF_Project2 Developer console
...
{\
	NSString * exceptionName = [@"org.avf_project2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.avf_project2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIAVF_Project2NativeItemNone = -1, 
	UIAVF_Project2NativeItemSpinner = -2,
	UIAVF_Project2NativeItemProgressBar = -3,
	
	UIAVF_Project2NativeItemSlider = -4,
	UIAVF_Project2NativeItemSwitch = -5,
	UIAVF_Project2NativeItemMultiButton = -6,
	UIAVF_Project2NativeItemSegmented = -7,
	
	UIAVF_Project2NativeItemTextView = -8,
	UIAVF_Project2NativeItemTextField = -9,
	UIAVF_Project2NativeItemSearchBar = -10,
	
	UIAVF_Project2NativeItemPicker = -11,
	UIAVF_Project2NativeItemDatePicker = -12,
	
	UIAVF_Project2NativeItemInfoLight = -13,
	UIAVF_Project2NativeItemInfoDark = -14,
	
	UIAVF_Project2NativeItemDisclosure = -15,
	
	UIAVF_Project2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all AVF_Project2 instances of
