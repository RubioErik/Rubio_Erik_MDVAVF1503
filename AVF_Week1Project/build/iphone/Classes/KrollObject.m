...
//@interface AVF_Week1ProjectObject : NSObject
//@end

@interface AVF_Week1ProjectObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AVF_Week1ProjectObject class]])
		{
			for (NSString *key in [[(AVF_Week1ProjectObject*)o modules] allKeys])
			{
