...
@interface AVF_Week1ProjectObject : KrollCoverageObject {
#else
@interface AVF_Week1ProjectObject : KrollObject {
#endif
@private
...
extern NSString * AVF_Week1Project$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	AVF_Week1ProjectObject *_avf_week1project;
    KrollObject* console;
	BOOL shutdown;
