...
//Rare exceptions to indicate a bug in the _avf_week1project code (Eg, function that a subclass should have implemented)
...
/**
 The base class for AVF_Week1Project proxies.
 */
