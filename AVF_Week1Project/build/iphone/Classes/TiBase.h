...
// in simulator we redefine to format for AVF_Week1Project Developer console
...
{\
	NSString * exceptionName = [@"org.avf_week1project." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.avf_week1project";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIAVF_Week1ProjectNativeItemNone = -1, 
	UIAVF_Week1ProjectNativeItemSpinner = -2,
	UIAVF_Week1ProjectNativeItemProgressBar = -3,
	
	UIAVF_Week1ProjectNativeItemSlider = -4,
	UIAVF_Week1ProjectNativeItemSwitch = -5,
	UIAVF_Week1ProjectNativeItemMultiButton = -6,
	UIAVF_Week1ProjectNativeItemSegmented = -7,
	
	UIAVF_Week1ProjectNativeItemTextView = -8,
	UIAVF_Week1ProjectNativeItemTextField = -9,
	UIAVF_Week1ProjectNativeItemSearchBar = -10,
	
	UIAVF_Week1ProjectNativeItemPicker = -11,
	UIAVF_Week1ProjectNativeItemDatePicker = -12,
	
	UIAVF_Week1ProjectNativeItemInfoLight = -13,
	UIAVF_Week1ProjectNativeItemInfoDark = -14,
	
	UIAVF_Week1ProjectNativeItemDisclosure = -15,
	
	UIAVF_Week1ProjectNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all AVF_Week1Project instances of
