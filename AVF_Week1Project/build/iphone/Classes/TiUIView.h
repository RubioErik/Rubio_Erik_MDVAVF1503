...
/**
 Base class for all AVF_Week1Project views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the AVF_Week1Project view hierarchy (such as wrapped iOS UIViews) was touched.
