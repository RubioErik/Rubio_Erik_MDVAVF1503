...
// in simulator we redefine to format for CloseGas Developer console
...
{\
	NSString * exceptionName = [@"org.closegas." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.closegas";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UICloseGasNativeItemNone = -1, 
	UICloseGasNativeItemSpinner = -2,
	UICloseGasNativeItemProgressBar = -3,
	
	UICloseGasNativeItemSlider = -4,
	UICloseGasNativeItemSwitch = -5,
	UICloseGasNativeItemMultiButton = -6,
	UICloseGasNativeItemSegmented = -7,
	
	UICloseGasNativeItemTextView = -8,
	UICloseGasNativeItemTextField = -9,
	UICloseGasNativeItemSearchBar = -10,
	
	UICloseGasNativeItemPicker = -11,
	UICloseGasNativeItemDatePicker = -12,
	
	UICloseGasNativeItemInfoLight = -13,
	UICloseGasNativeItemInfoDark = -14,
	
	UICloseGasNativeItemDisclosure = -15,
	
	UICloseGasNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all CloseGas instances of
