...
//@interface CloseGasObject : NSObject
//@end

@interface CloseGasObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[CloseGasObject class]])
		{
			for (NSString *key in [[(CloseGasObject*)o modules] allKeys])
			{
