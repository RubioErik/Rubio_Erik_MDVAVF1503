...
//@interface AVF_Week2ProjectObject : NSObject
//@end

@interface AVF_Week2ProjectObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AVF_Week2ProjectObject class]])
		{
			for (NSString *key in [[(AVF_Week2ProjectObject*)o modules] allKeys])
			{
