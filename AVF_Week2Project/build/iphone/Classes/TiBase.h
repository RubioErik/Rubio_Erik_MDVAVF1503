...
// in simulator we redefine to format for redditAPI Developer console
...
{\
	NSString * exceptionName = [@"org.redditapi." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.redditapi";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIredditAPINativeItemNone = -1, 
	UIredditAPINativeItemSpinner = -2,
	UIredditAPINativeItemProgressBar = -3,
	
	UIredditAPINativeItemSlider = -4,
	UIredditAPINativeItemSwitch = -5,
	UIredditAPINativeItemMultiButton = -6,
	UIredditAPINativeItemSegmented = -7,
	
	UIredditAPINativeItemTextView = -8,
	UIredditAPINativeItemTextField = -9,
	UIredditAPINativeItemSearchBar = -10,
	
	UIredditAPINativeItemPicker = -11,
	UIredditAPINativeItemDatePicker = -12,
	
	UIredditAPINativeItemInfoLight = -13,
	UIredditAPINativeItemInfoDark = -14,
	
	UIredditAPINativeItemDisclosure = -15,
	
	UIredditAPINativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all redditAPI instances of
