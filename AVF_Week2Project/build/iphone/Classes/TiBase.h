...
// in simulator we redefine to format for AVF_Week2Project Developer console
...
{\
	NSString * exceptionName = [@"org.avf_week2project." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.avf_week2project";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIAVF_Week2ProjectNativeItemNone = -1, 
	UIAVF_Week2ProjectNativeItemSpinner = -2,
	UIAVF_Week2ProjectNativeItemProgressBar = -3,
	
	UIAVF_Week2ProjectNativeItemSlider = -4,
	UIAVF_Week2ProjectNativeItemSwitch = -5,
	UIAVF_Week2ProjectNativeItemMultiButton = -6,
	UIAVF_Week2ProjectNativeItemSegmented = -7,
	
	UIAVF_Week2ProjectNativeItemTextView = -8,
	UIAVF_Week2ProjectNativeItemTextField = -9,
	UIAVF_Week2ProjectNativeItemSearchBar = -10,
	
	UIAVF_Week2ProjectNativeItemPicker = -11,
	UIAVF_Week2ProjectNativeItemDatePicker = -12,
	
	UIAVF_Week2ProjectNativeItemInfoLight = -13,
	UIAVF_Week2ProjectNativeItemInfoDark = -14,
	
	UIAVF_Week2ProjectNativeItemDisclosure = -15,
	
	UIAVF_Week2ProjectNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all AVF_Week2Project instances of
