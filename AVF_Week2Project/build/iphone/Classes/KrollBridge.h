...
@interface AVF_Week2ProjectObject : KrollCoverageObject {
#else
@interface AVF_Week2ProjectObject : KrollObject {
#endif
@private
...
extern NSString * AVF_Week2Project$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	AVF_Week2ProjectObject *_avf_week2project;
    KrollObject* console;
	BOOL shutdown;
