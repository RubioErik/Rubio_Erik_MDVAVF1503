...
/**
 Base class for all AVF_Week2Project views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the AVF_Week2Project view hierarchy (such as wrapped iOS UIViews) was touched.
