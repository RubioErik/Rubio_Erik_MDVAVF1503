...
/**
 The base class for all AVF_Week2Project modules
 */
...
/**
 AVF_Week2Project Platform calls this method on startup.
 */
-(void)startup;

/**
 AVF_Week2Project Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 AVF_Week2Project Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 AVF_Week2Project Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 AVF_Week2Project Platform calls this method on resume.
 @param sender The sender of the event.
 */
